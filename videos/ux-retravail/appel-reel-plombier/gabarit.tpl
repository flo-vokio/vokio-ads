...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  #agenda{position:absolute;left:60px;top:500px;width:__AG_W__px;height:840px}
...
<div id="root" data-composition-id="main" data-start="0" data-duration="__FIN_S__"
  ...
  <div id="agenda-clip" class="clip" data-start="65.3" data-duration="3.3" data-track-index="4">
    <div id="agenda"><div id="agenda-in"><img id="agenda-img" src="assets/plans/agenda-jour.png" alt=""></div></div>
  </div>
  ...
  <div id="titres" class="clip" data-start="0" data-duration="__FIN_S__" data-track-index="6">
    ...
    <div class="titre" data-layout-allow-overlap data-layout-allow-overflow id="t6"><span class="l"><span>Le lendemain,</span></span><span class="l em"><span>l'intervention est dans votre agenda.</span></span></div>
...
(function(){
  ...
  // ── l'agenda du lendemain : on s'approche de l'intervention posée ──
  tl.fromTo('#agenda', { opacity: 0, y: 90 }, { opacity: 1, y: 0, duration: .9, ease: E }, S(T.agendaIn));
  tl.fromTo('#agenda-img', { scale: 1 }, { scale: 1.1, duration: S(T.impactIn - T.agendaIn - 400), ease: "sine.inOut" }, S(T.agendaIn + 400));
