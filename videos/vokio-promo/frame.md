...
description: >
  ...
  as bloom / panel / tile underprint, Instrument Serif display + Geist sans + Geist Mono data,
...
typography:
  # — reading + data ramp —
  body:    { fontFamily: "Geist", cqw: 0.85, weight: 400, lineHeight: 1.5, color: "ink" }
  body-lede:{ fontFamily: "Geist", cqw: 0.95, weight: 400, lineHeight: 1.55 }
  micro-label:{ fontFamily: "Geist Mono", px: 13, weight: 600, tracking: "0.18em", upper: true }
  rail-label:{ fontFamily: "Geist Mono", px: 13, weight: 600, tracking: "0.32em", upper: true }
  mono-data:{ fontFamily: "Geist Mono", cqw: 0.73, weight: 400, tracking: "0.04em" }
  pagenum: { fontFamily: "Geist Mono", px: 13, weight: 400, tracking: "0.08em", opacity: 0.75 }
...
- **Fonts** — already set to **Instrument Serif** (display) / **Geist** (body) / **Geist Mono** (labels + data); ignore any preset font name lingering in prose.
...
negative tracking) carries every display, numeral, and quote from 40px to 720px+; **Geist** carries
body copy; **Geist Mono** carries every date, figure, and
...
- **Instrument Serif 400** display (tight, negative-tracked); **Geist** body + micro-labels; **Geist Mono** data.
...
Two ramps. The **reading/data ramp** (Geist body 0.85cqw ink, micro-labels in px, Geist Mono
...
- **Instrument Serif is weight 400 only** (its contrast is the weight signal), tight line-height (0.84–1.06), negative tracking; **micro-labels uppercase Geist Mono 600, ≥0.16em**; **mono for all numerals/dates**. No bold serif, no second text color, no mono in body/display.
...
- Set every line in **ink**; use **Instrument Serif 400** (tight, negative-tracked) for display, **Geist** body, **Geist Mono** for all numerals/dates.
- Make every separator a **1px ink hairline** (soft variant for dense rows); flood a **yellow panel** for poster moments (ink on top).
- Keep micro-labels **uppercase Geist Mono 600, 0.16–0.32em**; pin the **pagenum** bottom-right.
...
- **Geist + Geist + Geist Mono via Google Fonts.** CJK: Smiley Sans (display) / Noto Serif SC (body) / Noto Sans SC (labels); italic serif and mono tabular figures have no exact Hanzi equal — keep ledger dates Latin.
